...
const appointments = [
  {
    id: 0,
    title: 'Yoga Class',
    startDate: new Date(2021, 11, 7, 9, 30),
    endDate: new Date(2021, 11, 7, 11, 30),
    ...
    id: 1,
    title: 'Gardening',
    startDate: new Date(2021, 10, 28, 9, 30),
    endDate: new Date(2021, 10, 28, 11, 30)
  }, {
    id: 2,
    title: 'Face Masks',
    startDate: new Date(2021, 10, 9, 12, 0),
    endDate: new Date(2021, 10, 9, 13, 0)
  }, {
    id: 3,
    title: 'Massages',
    startDate: new Date(2021, 10, 18, 14, 30),
    endDate: new Date(2021, 10, 18, 15, 30)
  }, {
    id: 4,
    title: 'Technica',
    startDate: new Date(2021, 10, 13, 12, 0),
    endDate: new Date(2021, 10, 14, 13, 35),
    color: pink
  }, {
    id: 5,
    title: 'Watch Netflix',
    startDate: new Date(2021, 12, 6, 13, 0),
    endDate: new Date(2021, 12, 6, 14, 0)
  }
];
...
const FlexibleSpace = withStyles(styles, { name: 'ToolbarRoot' })(({ classes, ...restProps }) => (
  <Toolbar.FlexibleSpace {...restProps} className={classes.flexibleSpace}>
    <div className={classes.flexContainer}>
      <Typography variant="h5" style={{ marginLeft: '10px' }}>Self Care Scheduler</Typography>
    </div>
